Reborn.vehList = function()
	local vehs = {
		{ hash = 1924372706, name = 'fusca', price = 40000, banido = false, modelo = 'fusca', capacidade = 30, tipo = 'carros' },
		{ hash = 2046572318, name = '911turbos', price = 500000, banido = false, modelo = 'hilux2019', capacidade = 50, tipo = 'carros' },
		{ hash = -1691715558, name = 'jeep2012', price = 230000, banido = false, modelo = 'jeep2012', capacidade = 30, tipo = 'carros' },
		{ hash = -1246383966, name = 'jeepreneg', price = 300000, banido = false, modelo = 'jeepreneg', capacidade = 30, tipo = 'carros' },
		{ hash = 210550081, name = 'polo2018', price = 80000, banido = false, modelo = 'polo2018', capacidade = 30, tipo = 'carros' },
		{ hash = 1418132356, name = 'prius', price = 70000, banido = false, modelo = 'prius', capacidade = 30, tipo = 'carros' },
		{ hash = -361155694, name = 'punto', price = 130000, banido = false, modelo = 'punto', capacidade = 30, tipo = 'carros'}, 
		{ hash = -301519603, name = 'ram2500', price = 120000, banido = false, modelo = 'ram2500', capacidade = 30, tipo = 'carros' },
		{ hash = -1737994370, name = 'rencaptur', price = 100000, banido = false, modelo = 'rencaptur', capacidade = 30, tipo = 'carros' },
		{ hash = 1244288366, name = 'rr12', price = 300000, banido = false, modelo = 'rr12', capacidade = 30, tipo = 'carros' },
		{ hash = -404110988, name = 'santafe', price = 200000, banido = false, modelo = 'santafe', capacidade = 30, tipo = 'carros' },
		{ hash = -1586763167, name = 'sont18', price = 180000, banido = false, modelo = 'sont18', capacidade = 30, tipo = 'carros' },
		{ hash = 231217483, name = 'trhawk', price = 220000, banido = false, modelo = 'trhawk', capacidade = 30, tipo = 'carros' },
		{ hash = 1473628167, name = 'vwgolf', price = 220000, banido = false, modelo = 'vwgolf', capacidade = 30, tipo = 'carros' },
		{ hash = -1987109409, name = '150', price = 35000, banido = false, modelo = '150', capacidade = 30, tipo = 'carros' },
		{ hash = 2047166283, name = 'bmws', price = 35000, banido = false, modelo = 'bmws', capacidade = 30, tipo = 'carros' },
		{ hash = 735175855, name = 'cbrr', price = 35000, banido = false, modelo = 'cbrr', capacidade = 30, tipo = 'carros' },
		{ hash = 321407703, name = 'CBTWISTER', price = 35000, banido = false, modelo = 'biCBTWISTERz25', capacidade = 30, tipo = 'carros' },
		{ hash = 1671178289, name = 'd99', price = 35000, banido = false, modelo = 'd99', capacidade = 30, tipo = 'carros' },
		{ hash = -688419137, name = 'hayabusa', price = 35000, banido = false, modelo = 'hayabusa', capacidade = 30, tipo = 'carros' },
		{ hash = -1265899455, name = 'hcbr17', price = 35000, banido = false, modelo = 'hcbr17', capacidade = 30, tipo = 'carros' },
		{ hash = -1474280704, name = 'hvrod', price = 35000, banido = false, modelo = 'hvrod', capacidade = 30, tipo = 'carros' },
		{ hash = -1667727259, name = 'nh2r', price = 35000, banido = false, modelo = 'nh2r', capacidade = 30, tipo = 'carros' },
		{ hash = 1474015055, name = 'r1', price = 35000, banido = false, modelo = 'r1', capacidade = 30, tipo = 'carros' },
		{ hash = -188978926, name = 'r6', price = 35000, banido = false, modelo = 'r6', capacidade = 30, tipo = 'carros' },
		{ hash = -2049243343, name = 'rc', price = 35000, banido = false, modelo = 'rc', capacidade = 30, tipo = 'carros' },
		{ hash = 1744543800, name = 'z1000', price = 900000, banido = false, modelo = 'z1000', capacidade = 30, tipo = 'carros' },
		{ hash = 1709518892, name = 'zx10', price = 35000, banido = false, modelo = 'zx10', capacidade = 30, tipo = 'carros' },
		{ hash = -264618235, name = 'LAMtmc', price = 35000, banido = false, modelo = 'LAMtmc', capacidade = 30, tipo = 'carros' },
		{ hash = -991407206, name = 'r1250', price = 35000, banido = false, modelo = 'r1250', capacidade = 30, tipo = 'carros' },
		{ hash = 1221510024, name = 'nissantitan17', price = 35000, banido = false, modelo = 'nissantitan17', capacidade = 30, tipo = 'carros' },
		{ hash = -733499172, name = 'm8gte', price = 35000, banido = false, modelo = 'm8gte', capacidade = 30, tipo = 'carros' },
		{ hash = -530596092, name = '2f2fgtr34', price = 0, banido = false, modelo = 'R34-Droga eo brian', capacidade = 55, tipo = 'exclusive' },
		{ hash = -1947578251, name = 'amarok17', price = 1000000, banido = false, modelo = 'amarok17', capacidade = 200, tipo = 'carros' },
		{ hash = 1890188937, name = 'aventador', price = 2500000, banido = false, modelo = 'aventador', capacidade = 70, tipo = 'import' },
		{ hash = 1324588753, name = 'fnfmk4', price = 0, banido = false, modelo = 'Supra', capacidade = 30, tipo = 'exclusive' },
		{ hash = -372000475, name = 'fmgt', price = 99000000, banido = false, modelo = 'fmgt', capacidade = 70, tipo = 'exclusive' },
		{ hash = 104532066, name = 'g65amg', price = 99000000, banido = false, modelo = 'g65amg', capacidade = 70, tipo = 'exclusive' },
		{ hash = 1421669475, name = 'laferrari17', price = 1300000, banido = false, modelo = 'laferrari17', capacidade = 70, tipo = 'import' },
		{ hash = -972219160, name = 'm6gc', price = 99000000, banido = false, modelo = 'm6gc', capacidade = 70, tipo = 'exclusive' },
		...
		{ hash = 1549126457, name = 'skyline', price = 99000000, banido = false, modelo = 'skyline', capacidade = 70, tipo = 'exclusive' },
		{ hash = 1744543800, name = 'z1000', price = 99000000, banido = false, modelo = 'z1000', capacidade = 70, tipo = 'import' },
		{ hash = -1156537658, name = 'tiger', price = 99000000, banido = false, modelo = 'tiger', capacidade = 200, tipo = 'exclusive' },
		{ hash = -536870494, name = 'jellybigpeen', price = 99000000, banido = false, modelo = 'jellybigpeen', capacidade = 70, tipo = 'exclusive' },
		{ hash = -1223256869, name = 'bugatticentodieci', price = 99000000, banido = false, modelo = 'bugatticentodieci', capacidade = 70, tipo = 'exclusive' },
		{ hash = 2112052861, name = 'pounder', price = 1000000, banido = false, modelo = 'pounder', capacidade = 520, tipo = 'carros' },
		{ hash = 980885719, name = 'rmodgt63', price = 99000000, banido = false, modelo = 'rmodgt63', capacidade = 70, tipo = 'exclusive' },
		{ hash = -1670780519, name = 'z4alchemist', price = 1800000, banido = false, modelo = 'z4alchemist', capacidade = 70, tipo = 'import' },
		{ hash = 1549126457, name = 'z4bmw', price = 99000000, banido = false, modelo = 'z4bmw', capacidade = 70, tipo = 'exclusive' },
		{ hash = 1221510024, name = 'nissantitan17', price = 99000000, banido = false, modelo = 'nissantitan17', capacidade = 150, tipo = 'import' },
		{ hash = 949614817, name = 'lp700r', price = 99000000, banido = false, modelo = 'lambo', capacidade = 70, tipo = 'exclusive' },
		{ hash = -1942383131, name = '2020ss', price = 2000000, banido = false, modelo = 'camaro', capacidade = 70, tipo = 'carros' },
		{ hash = 1549126457, name = 'baller250', price = 7000000, banido = false, modelo = 'f250', capacidade = 150, tipo = 'import' },
		{ hash = -1978168465, name = 'hondacivictr', price = 99000000, banido = false, modelo = 'hondacivictr', capacidade = 70, tipo = 'exclusive' },
		{ hash = 2046572318, name = '911turbos', price = 99000000, banido = false, modelo = '911turbos', capacidade = 50, tipo = 'exclusive' },
		{ hash = -1119300334, name = 'amggtr2', price = 99000000, banido = false, modelo = 'amggtr2', capacidade = 50, tipo = 'exclusive' },
		{ hash = -124294908, name = 'b63s', price = 1500000, banido = false, modelo = 'b63s', capacidade = 50, tipo = 'import' },
		{ hash = 1093697054, name = 'bmci', price = 99000000, banido = false, modelo = 'BMW M5', capacidade = 50, tipo = 'exclusive' },
		{ hash = -493679946, name = 'civic', price = 450000, banido = false, modelo = 'civic', capacidade = 50, tipo = 'carros' },
		{ hash = -1543097373, name = 'f80', price = 99000000, banido = false, modelo = 'Ferrari f80', capacidade = 50, tipo = 'exclusive' },
		{ hash = 1651538600, name = 'f458', price = 99000000, banido = false, modelo = 'Ferrari Italia', capacidade = 50, tipo = 'exclusive' },
		{ hash = -1019985014, name = 'jagpr8', price = 2200000, banido = false, modelo = 'Jagua', capacidade = 70, tipo = 'import' },
		{ hash = 381357986, name = 'lx2018', price = 99000000, banido = false, modelo = 'Nexus', capacidade = 70, tipo = 'exclusive' },
		{ hash = 909765281, name = 'm4f82', price = 1550000, banido = false, modelo = 'BMW m4f82', capacidade = 50, tipo = 'import' },
		{ hash = 1241978166, name = 'macan', price = 1500000, banido = false, modelo = 'macan', capacidade = 50, tipo = 'exclusive' },
		{ hash = -189485405, name = 'mers63c', price = 1250000, banido = false, modelo = 'Mercedes63c', capacidade = 50, tipo = 'import' },
		{ hash = 1524511588, name = 'p7', price = 99000000, banido = false, modelo = 'Jagua P7', capacidade = 50, tipo = 'exclusive' },
		{ hash = 194366558, name = 'panamera17turbo', price = 99000000, banido = false, modelo = 'Panamera turbo', capacidade = 50, tipo = 'exclusive' },
		{ hash = -1698677681, name = 'rmodlp750', price = 99000000, banido = false, modelo = 'Veneno P750', capacidade = 50, tipo = 'exclusive' },
		{ hash = 62986539, name = 'rmodveneno', price = 99000000, banido = false, modelo = 'Lamborghini Veneno', capacidade = 50, tipo = 'exclusive' },
		{ hash = 1752384486, name = 'rx7veilside', price = 99000000, banido = false, modelo = 'rx7veilside', capacidade = 50, tipo = 'exclusive' },
		{ hash = 955653233, name = 'trailcat', price = 70000, banido = false, modelo = 'trailcat', capacidade = 50, tipo = 'carros' },
		--{ hash = 310570430, name = 'velociraptor', price = 99000000, banido = false, modelo = 'Javelociraptorgua', capacidade = 500, tipo = 'exclusive' },
		{ hash = -2098954619, name = 'club', price = 100000, banido = false, modelo = 'Brasilia', capacidade = 50, tipo = 'carros' },
		{ hash = -208911803, name = 'jugular', price = 450000, banido = false, modelo = 'Jagua2', capacidade = 50, tipo = 'carros' },
		{ hash = 1644055914, name = 'weevil', price = 30000, banido = false, modelo = 'Fusca', capacidade = 50, tipo = 'carros' },
		{ hash = 409049982, name = 'kanjo', price = 150000, banido = false, modelo = 'Civic Antigo', capacidade = 50, tipo = 'carros' },
		{ hash = 1118611807, name = 'asbo', price = 450000, banido = false, modelo = 'Corsa', capacidade = 50, tipo = 'carros' },
		{ hash = 987469656, name = 'sugoi', price = 450000, banido = false, modelo = 'Honda Civic', capacidade = 50, tipo = 'carros' },
		...
		{ hash = 470404958, name = 'baller5', price = 10000000, banido = false, modelo = 'Baller5', capacidade = 50, tipo = 'carros' },
		{ hash = 666166960, name = 'baller6', price = 15000000, banido = false, modelo = 'Baller6', capacidade = 50, tipo = 'carros' },
		...
		{ hash = -432008408, name = 'xls2', price = 15000000, banido = false, modelo = 'Xls2', capacidade = 50, tipo = 'carros' },
		...
		{ hash = -2030171296, name = 'cognoscenti', price = 2800000, banido = false, modelo = 'Cognoscenti', capacidade = 50, tipo = 'carros' },
		{ hash = -604842630, name = 'cognoscenti2', price = 10000000, banido = false, modelo = 'Cognoscenti2', capacidade = 50, tipo = 'carros' },
		...
		{ hash = -344943009, name = 'blista', price = 25000, banido = false, modelo = 'Blista', capacidade = 40, tipo = 'carros' },
		{ hash = 1549126457, name = 'brioso', price = 20000, banido = false, modelo = 'Brioso', capacidade = 40, tipo = 'carros' },
		...
		{ hash = -2022483795, name = 'comet3', price = 490000, banido = false, modelo = 'Comet3', capacidade = 40, tipo = 'carros' },
		{ hash = 661493923, name = 'comet5', price = 500000, banido = false, modelo = 'Comet5', capacidade = 40, tipo = 'carros' },
		{ hash = 108773431, name = 'coquette', price = 450000, banido = false, modelo = 'Coquette', capacidade = 30, tipo = 'carros' },
		{ hash = 196747873, name = 'elegy', price = 700000, banido = false, modelo = 'Elegy', capacidade = 30, tipo = 'carros' },
		{ hash = -566387422, name = 'elegy2', price = 855000, banido = false, modelo = 'Elegy2', capacidade = 30, tipo = 'carros' },
		...
		{ hash = 2016857647, name = 'futo', price = 70000, banido = false, modelo = 'Futo', capacidade = 40, tipo = 'carros' },
		{ hash = -1297672541, name = 'jester', price = 550000, banido = false, modelo = 'Jester', capacidade = 30, tipo = 'carros' },
		{ hash = 544021352, name = 'khamelion', price = 410000, banido = false, modelo = 'Khamelion', capacidade = 50, tipo = 'carros' },
		{ hash = -1372848492, name = 'kuruma', price = 330000, banido = false, modelo = 'Kuruma', capacidade = 50, tipo = 'carros' },
		{ hash = -142942670, name = 'massacro', price = 600000, banido = false, modelo = 'Massacro', capacidade = 40, tipo = 'carros' },
		{ hash = -631760477, name = 'massacro2', price = 800000, banido = false, modelo = 'Massacro2', capacidade = 40, tipo = 'carros' },
		...
		{ hash = 970598228, name = 'sultan', price = 830000, banido = false, modelo = 'Sultan', capacidade = 50, tipo = 'carros' },
		...
		{ hash = 1747439474, name = 'Stockade', price = 90, banido = false, modelo = 'stockade', capacidade = 40, tipo = 'work' },
		{ hash = 117401876, name = 'btype', price = 300000, banido = false, modelo = 'Btype', capacidade = 40, tipo = 'work' },
		{ hash = -831834716, name = 'btype2', price = 460000, banido = false, modelo = 'Btype2', capacidade = 20, tipo = 'carros' },
		{ hash = -602287871, name = 'btype3', price = 490000, banido = false, modelo = 'Btype3', capacidade = 40, tipo = 'carros' },
		...
		{ hash = -2079788230, name = 'gt500', price = 550000, banido = false, modelo = 'Gt500', capacidade = 40, tipo = 'carros' },
		{ hash = -1405937764, name = 'infernus2', price = 550000, banido = false, modelo = 'Infernus2', capacidade = 20, tipo = 'carros' },
		{ hash = 1051415893, name = 'jb700', price = 220000, banido = false, modelo = 'Jb700', capacidade = 30, tipo = 'carros' },
		{ hash = -1660945322, name = 'mamba', price = 500000, banido = false, modelo = 'Mamba', capacidade = 50, tipo = 'carros' },
		...
		{ hash = 2049897956, name = 'rapidgt3', price = 820000, banido = false, modelo = 'Rapidgt3', capacidade = 40, tipo = 'carros' },
		...
		{ hash = 1034187331, name = 'nero', price = 850000, banido = false, modelo = 'Nero', capacidade = 20, tipo = 'carros' },
		{ hash = 1093792632, name = 'nero2', price = 1800000, banido = false, modelo = 'Nero2', capacidade = 20, tipo = 'carros' },
		...
		{ hash = 1475773103, name = 'rumpo3', price = 2500000, banido = false, modelo = 'Rumpo3', capacidade = 120, tipo = 'carros' },
		...
		{ hash = -2107990196, name = 'guardian', price = 1200000, banido = false, modelo = 'Guardian', capacidade = 150, tipo = 'carros' },
		...
		{ hash = 1945374990, name = 'mule4', price = 1000000, banido = false, modelo = 'Burrito4', capacidade = 400, tipo = 'carros' },
		{ hash = -2103821244, name = 'rallytruck', price = 99000000, banido = false, modelo = 'Burrito4', capacidade = 1500, tipo = 'exclusive' },
		...
		{ hash = 2091594960, name = 'tr4', price = 10000, banido = true, modelo = 'Cars', capacidade = 0, tipo = 'work' },
		{ hash = -60313827, name = 'nissangtr', price = 99000000, banido = false, modelo = 'Nissan GTR', capacidade = 40, tipo = 'exclusive' },
		{ hash = -2015218779, name = 'nissan370z', price = 1800000, banido = false, modelo = 'Nissan 370Z', capacidade = 40, tipo = 'exclusive' },
		{ hash = 1601422646, name = 'dodgechargersrt', price = 2000000, banido = false, modelo = 'Dodge Charger SRT', capacidade = 50, tipo = 'import' },
		{ hash = -1173768715, name = 'ferrariitalia', price = 99000000, banido = false, modelo = 'Ferrari Italia 478', capacidade = 30, tipo = 'exclusive' },
		{ hash = 1978768527, name = '14r8', price = 1000000, banido = false, modelo = 'Audi R8 2014', capacidade = 30, tipo = 'exclusive' },
		{ hash = 1676738519, name = 'audirs6', price = 2200000, banido = false, modelo = 'Audi RS6', capacidade = 60, tipo = 'import' },
		{ hash = -157095615, name = 'bmwm3f80', price = 1350000, banido = false, modelo = 'BMW M3 F80', capacidade = 50, tipo = 'import' },
		{ hash = -13524981, name = 'bmwm4gts', price = 99000000, banido = false, modelo = 'BMW M4 GTS', capacidade = 70, tipo = 'exclusive' },
		...
		{ hash = 1978088379, name = 'lancerevolutionx', price = 1800000, banido = false, modelo = 'Lancer Evolution X', capacidade = 50, tipo = 'import' },
		{ hash = 2034235290, name = 'mazdarx7', price = 1800000, banido = false, modelo = 'Mazda RX7', capacidade = 40, tipo = 'exclusive' },
		{ hash = 670022011, name = 'nissangtrnismo', price = 1500000, banido = false, modelo = 'Nissan GTR Nismo', capacidade = 40, tipo = 'exclusive' },
		{ hash = -4816535, name = 'nissanskyliner34', price = 99000000, banido = false, modelo = 'Nissan Skyline R34', capacidade = 50, tipo = 'exclusive' },
		{ hash = 351980252, name = 'teslaprior', price = 1500000, banido = false, modelo = 'Tesla Prior', capacidade = 50, tipo = 'import' },
		{ hash = 723779872, name = 'toyotasupra', price = 99000000, banido = false, modelo = 'Toyota Supra', capacidade = 35, tipo = 'exclusive' },
		{ hash = -740742391, name = 'mercedesa45', price = 99000000, banido = false, modelo = 'Mercedes A45', capacidade = 40, tipo = 'import' },
		...
		{ hash = -189438188, name = 'p1gtr', price = 99000000, banido = false, modelo = 'Mclaren P1', capacidade = 20, tipo = 'exclusive' },
		{ hash = 1718441594, name = 'i8', price = 99000000, banido = false, modelo = 'BMW i8', capacidade = 35, tipo = 'exclusive' },
		...
		{ hash = -915188472, name = 'amggtr', price = 99000000, banido = false, modelo = 'Mercedes AMG', capacidade = 70, tipo = 'exclusive' },
		...
		{ hash = 2047166283, name = 'bmws', price = 99000000, banido = false, modelo = 'BMW S1000', capacidade = 15, tipo = 'exclusive' },
		{ hash = 494265960, name = 'cb500x', price = 9900000, banido = false, modelo = 'Honda CB500', capacidade = 15, tipo = 'exclusive' },
		...
		{ hash = 1224601968, name = '19ftype', price = 2300000, banido = false, modelo = 'Jaguar F-Type', capacidade = 50, tipo = 'exclusive' },
		...
		{ hash = -192929549, name = 'audirs7', price = 77000000, banido = false, modelo = 'Audi RS7', capacidade = 60, tipo = 'exclusive' },
		...
		{ hash = -1845487887, name = 'volatus', price = 99000000, banido = false, modelo = 'Volatus', capacidade = 45, tipo = 'exclusive' },
		...
		{ hash = -714386060, name = 'zx10r', price = 99000000, banido = false, modelo = 'Kawasaki ZX10R', capacidade = 20, tipo = 'exclusive' },
		...
		{ hash = 69730216, name = 'foxshelby', price = 1400000, banido = false, modelo = 'Ford Shelby GT500', capacidade = 40, tipo = 'exclusive' },
		...
		{ hash = -431692672, name = 'panto', price = 15000, banido = false, modelo = 'Panto', capacidade = 130, tipo = 'sedans' },
		{ hash = -1744543800, name = 'z1000', price = 410000, banido = false, modelo = 'Kawasaki Panto', capacidade = 10, tipo = 'motos' },
		{ hash = -536870494, name = 'jellybigpeen', price = 700000, banido = false, modelo = 'Ferrari 512 TR', capacidade = 40, tipo = 'sports' },
		{ hash = -90913175, name = 'mk1rabbit', price = 35000, banido = false, modelo = 'Golf GTI Rabbit', capacidade = 30, tipo = 'classicos' },
		{ hash = -310570430, name = 'velociraptor', price = 700000, banido = false, modelo = 'F150 Raptor', capacidade = 70, tipo = 'outros' },
		{ hash = -2047166283, name = 'bmws', price = 700000, banido = false, modelo = 'BMW S 1000RR', capacidade = 10, tipo = 'motos' },
		{ hash = -1672062838, name = 'p90d', price = 200000, banido = false, modelo = 'Tesla P90D', capacidade = 40, tipo = 'sedans' },
		{ hash = -1223256869, name = 'bugatticentodieci', price = 2000000, banido = false, modelo = 'Buggati', capacidade = 40, tipo = 'sports' },
		{ hash = -980885719, name = 'rmodgt63', price = 600000, banido = false, modelo = 'Mercedes GT63', capacidade = 40, tipo = 'sedans' },
		{ hash = -745393879, name = 'z4bmw', price = 600000, banido = false, modelo = 'BMW Z4', capacidade = 40, tipo = 'sports' },
		{ hash = -1221510024, name = 'nissantitan17', price = 600000, banido = false, modelo = 'Nissan Titan', capacidade = 70, tipo = 'outros' },
		{ hash = -654239719, name = 'agerars', price = 00000, banido = false, modelo = 'Koeniseg Agera (VIP)', capacidade = 40, tipo = 'sports' },
		{ hash = -836213613, name = '18performante', price = 2500000, banido = false, modelo = 'Lambo Huracan', capacidade = 40, tipo = 'sports' },
		{ hash = -1313740730, name = 'm2', price = 450000, banido = false, modelo = 'BMW M2', capacidade = 40, tipo = 'sedans' },
		{ hash = -949614817, name = 'lp700r', price = 2600000, banido = false, modelo = 'Lambo LP700R', capacidade = 40, tipo = 'sports' },
		{ hash = -2096912321, name = 'filthynsx', price = 2000000, banido = false, modelo = 'Acura NSX Filthy', capacidade = 40, tipo = 'sports' },
		{ hash = -1580061238, name = 'baller250', price = 1400000, banido = false, modelo = 'F250 Race SX Edition', capacidade = 70, tipo = 'outros' },
		{ hash = -1978168465, name = 'hondacivictr', price = 700000, banido = false, modelo = 'Civic Type R', capacidade = 40, tipo = 'sports' },
		{ hash = -188978926, name = 'r6', price = 900000, banido = false, modelo = 'Yamaha R6', capacidade = 10, tipo = 'motos' },
		{ hash = -2049243343, name = 'rc', price = 150000, banido = false, modelo = 'KTM RC', capacidade = 10, tipo = 'motos' },
		{ hash = -1676738519, name = 'audirs6', price = 280000, banido = false, modelo = 'Audi RS6', capacidade = 40, tipo = 'imports' },
		{ hash = -192929549, name = 'audirs7', price = 290000, banido = false, modelo = 'Audi RS7', capacidade = 40, tipo = 'sedans' },
		{ hash = -13524981, name = 'bmwm4gts', price = 80000, banido = false, modelo = 'BMW M4 GTS', capacidade = 40, tipo = 'sports' },
		{ hash = -1173768715, name = 'ferrariitalia', price = 2650000, banido = false, modelo = 'Ferrari Italia', capacidade = 40, tipo = 'sports' },
		{ hash = -1573350092, name = 'fordmustang', price = 200000, banido = false, modelo = 'Ford Mustang 2021', capacidade = 40, tipo = 'sports' },
		{ hash = -1978088379, name = 'lancerevolutionx', price = 550000, banido = false, modelo = 'Lancer Evolution', capacidade = 40, tipo = 'sports' },
		{ hash = -2034235290, name = 'mazdarx7', price = 600000, banido = false, modelo = 'Mazda RX-7', capacidade = 40, tipo = 'sports' },
		{ hash = -60313827, name = 'nissangtr', price = 700000, banido = false, modelo = 'Ford Mustang 2021', capacidade = 40, tipo = 'sports' },
		{ hash = -2046572318, name = '911turbos', price = 000000, banido = false, modelo = 'Porsche 911 (VIP)', capacidade = 40, tipo = 'sports' },
		{ hash = -11119300334, name = 'amggtr2', price = 400000, banido = false, modelo = 'Mercedes GTR2', capacidade = 40, tipo = 'sports' },
		{ hash = -124294908, name = 'b63s', price = 360000, banido = false, modelo = 'Brabus B63s', capacidade = 40, tipo = 'outros' },
		{ hash = -493679946, name = 'civic', price = 90000, banido = false, modelo = 'Civic SI 97', capacidade = 40, tipo = 'sedans' },
		{ hash = -1543097373, name = 'f80', price = 00000, banido = false, modelo = 'Ferrari F80 (VIP)', capacidade = 40, tipo = 'sports' },
		{ hash = -1718441594, name = 'i8', price = 700000, banido = false, modelo = 'BMW I8', capacidade = 40, tipo = 'sports' },
		{ hash = -381357986, name = 'lx2018', price = 450000, banido = false, modelo = 'Lexus 570 LX', capacidade = 40, tipo = 'outros' },
		{ hash = -1241978166, name = 'macan', price = 230000, banido = false, modelo = 'Porsche Macan', capacidade = 40, tipo = 'outros' },
		{ hash = -189485405, name = 'mers63c', price = 320000, banido = false, modelo = 'Mercedes S63', capacidade = 40, tipo = 'sedans' },
		{ hash = -1707353429, name = 'monza', price = 00000, banido = false, modelo = 'Ferrari Monza (VIP)', capacidade = 40, tipo = 'sports' },
		{ hash = -1215232069, name = 'p1gtr', price = 00000, banido = false, modelo = 'McLaren P1 (VIP MASTER)', capacidade = 40, tipo = 'sports' },
		{ hash = -194366558, name = 'panamera17turbo', price = 700000, banido = false, modelo = 'Porsche Panamera Turbo', capacidade = 40, tipo = 'sports' },
		{ hash = -1698677681, name = 'rmodlp750', price = 3000000, banido = false, modelo = 'Lambo LP-750 Special Edition', capacidade = 40, tipo = 'sports' },
		{ hash = -1752384486, name = 'rx7veilside', price = 1800000, banido = false, modelo = 'Rx7 VS', capacidade = 40, tipo = 'sports' },
		{ hash = -1236347001, name = 'rxf7', price = 000000, banido = false, modelo = 'Mazda RX-F7 (VIP)', capacidade = 40, tipo = 'sports' },
		{ hash = -955653233, name = 'trailcat', price = 200000, banido = false, modelo = 'Jeep TrailCat', capacidade = 10, tipo = 'outros' },
		{ hash = -55628203, name = 'faggio2', price = 10000, banido = false, modelo = 'Motinha de Pobre + Ifood', capacidade = 10, tipo = 'motos' },
		{ hash = -1924372706, name = 'fusca', price = 25000, banido = false, modelo = 'Fusca de Bandido', capacidade = 20, tipo = 'outros' },
		{ hash = -1547680982, name = 'hilux2016', price = 600000, banido = false, modelo = 'Hilux 2016 de Goias', capacidade = 70, tipo = 'outros' },
		{ hash = -701696699, name = 'jetta', price = 250000, banido = false, modelo = 'Jetta Rebaixado', capacidade = 40, tipo = 'sports' },
		{ hash = -515734555, name = 'astra', price = 300000,banido = false, modelo = 'Astra SS dos Melhores', capacidade = 40, tipo = 'sports' },
		{ hash = -997601910, name = 'cronos', price = 50000, banido = false, modelo = 'Fiat Cronos', capacidade = 20, tipo = 'sedans' },
		{ hash = -1062355240, name = 'uno', price = 40000, banido = false, modelo = 'Uno Sporting 1.4', capacidade = 20, tipo = 'outros' },
		{ hash = -519002268, name = 'versa', price = 80000, banido = false, modelo = 'Nissan Versa 1.8', capacidade = 40, tipo = 'sedans' },
		{ hash = -193064196, name = 'escort', price = 45000, banido = false, modelo = 'Escort de Cria', capacidade = 20, tipo = 'outros' },
		{ hash = -1663453404, name = 'evoque', price = 600000, banido = false, modelo = 'Range Rover Evoque', capacidade = 20, tipo = 'outros' },
		{ hash = -1125130375, name = 'polo', price = 70000, banido = false, modelo = 'Polo Turbo', capacidade = 20, tipo = 'sports' },
	}
	return vehs
end