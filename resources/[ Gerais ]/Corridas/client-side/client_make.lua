...
vmSERVER = Tunnel.getInterface("Make")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local races = {}
...
-- SELECTRACES
-----------------------------------------------------------------------------------------------------------------------------------------
function mkVRP.selectRaces(number)
	inRace = true
	checkPoint = 1
	raceSelect = number
...
-- FINISHRACES
-----------------------------------------------------------------------------------------------------------------------------------------
function mkVRP.finishRaces(race)
				...
				if distance <= 200 then
					...
					if distance <= 10 then
						...
						if checkPoint >= #races[raceSelect] then
							inRace = false
							vmSERVER.finishRaces(raceSelect)
