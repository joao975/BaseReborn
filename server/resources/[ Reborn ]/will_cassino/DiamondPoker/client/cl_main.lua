    ...
    self.createPed = function()
        Citizen.CreateThread(
            function()
                ...
                --SetPedMainFlag(self.ped, 185, true)
                --SetPedMainFlag(self.ped, 108, true)
                SetPedCanEvasiveDive(self.ped, 0)
                SetPedCanRagdollFromPlayerImpact(self.ped, 0)
                --SetPedMainFlag(self.ped, 208, true)
                    ...
                    while activePokerTable do
                        ...
                        if playerBetted == nil or playerPairPlus == nil then
                            if self.TimeLeft == nil or self.TimeLeft > 0 then
                                ...
                                if IsDisabledControlJustPressed(0, 172) then -- up
                                    local increase = Main.IncreaseAmounts(currentBetInput)
                        ...
                        if self.Active then
                            if self.TimeLeft >= 10 then
                                ...
                                DrawAdvancedNativeText(1.013, 0.806, 0.005, 0.0028, 0.29, translate('remaining_time'), 255, 255, 255, 255, 0, 0)
                        ...
                        DrawAdvancedNativeText(0.965, 0.849, 0.005, 0.0028, 0.29, translate('table_min_max'), 255, 255, 255, 255, 0, 0)
                        ...
                        DrawAdvancedNativeText(0.965, 0.892, 0.005, 0.0028, 0.29, translate('current_player_chips'), 255, 255, 255, 255, 0, 0)
                        ...
                        DrawAdvancedNativeText(0.965, 0.935, 0.005, 0.0028, 0.29, translate('current_bet_input'), 255, 255, 255, 255, 0, 0)
    ...
    function()
        while true do
            ...
            for k, v in pairs(Config.Pokers) do
                if #(playerpos - v.Position) < 20.0 then
                    closeToPokers = true
                end
            end
            Citizen.Wait(1000)
...
Citizen.CreateThread(
    function()
        ...
        Citizen.Wait(10000) -- repairs the client crash on login
        ...
        Main.DebugMsg('Poker loading started..')
...
RMenu:Get('aquiver_poker', 'instructions'):SetSubtitle(translate('tcp')) ]]

function showHowTo()
    Citizen.CreateThread(
        function()
            local helps = {translate('desc_1'), translate('desc_2'), translate('desc_3')}
            ...
            for i = 1, #helps, 1 do
                ...
                EndTextCommandDisplayHelp(0, false, false, 4000)
...
function showRules()
    Citizen.CreateThread(
        function()
            local helps = {translate('rule_1'), translate('rule_2'), translate('rule_3'), translate('rule_4'), translate('rule_5')}
            local helpsHeader = {translate('rule_header_1'), translate('rule_header_2'), translate('rule_header_3'), translate('rule_header_4'), translate('rule_header_5')}
...
RegisterCommand(
    ...
    function()
        ...
        for i = 1, #Main.Tables, 1 do
            local obj = GetClosestObjectOfType(playercoords, 5.0, GetHashKey(Main.Tables[i]), false, false, false)
            if DoesEntityExist(obj) then
                found = true
                print('Poker table position: ' .. GetEntityCoords(obj))
                print('Poker table heading: ' .. GetEntityHeading(obj))
                print('(Does not matter in the Main) Poker table model: ' .. Main.Tables[i])
            end
        end
