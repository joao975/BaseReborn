...
const Vs = ["Janeiro", "Fevereiro", "MarÃ§o", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"],
...
class lo {
    ...
    createStuff() {
        if (!this.gl) {
            for (let e = 0; e < 10; e += 1) console.log("VocÃª estÃ¡ bugado! NÃ£o possÃ­vel criar o contexto WebGL, este problema nÃ£o tem correÃ§Ã£o");
            return
        }
        const e = this.gl,
            t = function(e) {
...
var _o = {
    ...
    async promptImageURL() {
        ...
        if (e) throw this.alert("URL invÃ¡lida"), new Error("URL invÃ¡lida")
    },
    confirm: null
};
const Ao = {
...
vc.render = function(e, t, n, l, a, s) {
    ...
    }, "ConfiguraÃ§Ãµes", 2)]), Pl("div", Cc, [Pl("div", {
    ...
    }, " Restaurar configuraÃ§Ãµes "), l.microphone ? Ml("", !0) : (wl(), _l("button", {
        key: 2,
...
const vu = {
        ...
        setup() {
            ...
            return {
                contact: n,
                save: function() {
                    return n.phone === _o.identity.phone ? t("VocÃª nÃ£o pode adicionar a si mesmo") : n.phone ? n.name ? void _o.backend.addContact(n.phone, n.name).then((n => {
                        n instanceof Object ? (_o.contacts.value.push(n), e.back(), _o.pusher.emit("ADD_CONTACT", n)) : t("Este telefone nÃ£o existe!")
                    })) : t("Preencha o nome do contato") : t("Preencha o nÃºmero de telefone")
                }
            }
        }
    },
...
const Au = {
        ...
        setup() {
            ...
            return Object.assign(l, a), !a && e.back(), {
                contact: l,
                save: function() {
                    return l.phone === _o.identity.phone ? n("VocÃª nÃ£o pode adicionar a si mesmo") : l.phone ? l.name ? l.phone != a.phone && _o.contacts.value.some((e => e.phone == l.phone)) ? n("VocÃª jÃ¡ possui um contato com este nÃºmero") : void _o.backend.updateContact(l.id, l.phone, l.name).then((t => {
                        if (t.error) return n(t.error);
                        Object.assign(a, t), _o.sortContacts(), e.back()
                    })) : n("Preencha o nome do contato") : n("Preencha o nÃºmero de telefone")
                }
            }
        }
    },
        ...
        setup() {
            ...
            return {
                ...
                save: async function() {
                    ...
                    if (a) return l.value == _o.identity.phone ? n("NÃºmero invÃ¡lido") : a.length > 128 ? n("Nome invÃ¡lido") : void _o.backend.addContact(l.value, a).then((e => {
                        e instanceof Object ? (_o.contacts.value.push(e), l.value = "", _o.pusher.emit("ADD_CONTACT", e)) : n("Este nÃºmero nÃ£o existe")
                    }))
                },
                backspace: function() {
                    const e = l.value;
                ...
                call: function(e = !1) {
                    if (!l.value || l.value == _o.identity.phone) return n("NÃºmero invÃ¡lido");
...
id.render = function(e, t, n, l, a, s) {
    ...
    }, null, 2)) : (wl(), _l("i", bd))]), Pl("div", gd, [Pl("h1", vd, g(t.callback ? e.$filters.getNameByPhone(l.other(t)) : "(AnÃ´nimo)"), 1), Pl("span", xd, g(e.$filters.duration(t.duration)), 1)]), Pl("span", yd, g(e.$filters.unixToDayOfMonth(t.created_at)), 1)], 8, ["onClick"])))), 128))])) : (wl(), _l("h1", pd, " VocÃª nÃ£o realizou nenhuma ligaÃ§Ã£o ")) : (wl(), _l("div", dd, [Pl(r)]))]), Pl(i)])
};
const kd = {
        components: {
            Header: zc,
...
kd.render = function(e, t, n, l, a, s) {
    ...
    return wl(), _l("div", wd, [Pl(o, {
        ...
        class: "border-b border-theme p-5 flex items-center"
    }, [Pl("h1", Rd, g(e.$filters.getNameByPhone(t)), 1), Td], 8, ["onClick"])))), 128))])) : (wl(), _l("h1", Ad, " Nenhum nÃºmero bloqueado ")) : (wl(), _l("div", _d, [Pl(r)]))]), Pl(i)])
};
const Ed = {
        setup() {
...
Ed.render = function(e, t, n, l, a, s) {
    return wl(), _l("div", Pd, [Pl("div", Ld, [Id, Pl("button", {
        ...
        "onUpdate:modelValue": t[2] || (t[2] = e => l.query = e),
        placeholder: "Pesquise um nÃºmero ou contato",
        type: "text",
    ...
    }, [Pl("div", $d, [Pl("h1", jd, g(e.$filters.getNameByPhone(t.phone)), 1), t.message ? (wl(), _l("p", Fd, g(t.message.content || (t.message.image ? "ðŸ“· Foto" : "ðŸŒŽ LocalizaÃ§Ã£o")), 1)) : (wl(), _l("p", zd, "Nenhuma mensagem..."))]), t.message ? (wl(), _l("p", Bd, g(e.$filters.unixToRelative(t.message.created_at)), 1)) : Ml("", !0)], 8, ["onClick"])))), 128))])])
};
const Hd = {
        setup() {
            jl("setDark")(_o.darkTheme.value);
...
}, [Pl("h1", Ap, g(l.call.isAnonymous && !l.call.owner ? "AnÃ´nimo" : l.call.contact.name.substr(0, 16)), 1), Pl("span", Sp, g(e.$filters.duration(l.duration)), 1), l.video.big ? (wl(), _l("div", Rp, [Pl("canvas", Tp, null, 512)])) : Ml("", !0), l.video.small ? (wl(), _l("div", Ep, [Pl("canvas", Pp, null, 512)])) : Ml("", !0), Pl("div", Lp, [l.call.accepted || l.call.owner ? (wl(), _l("div", jp, [Pl("button", {
...
const xf = {
        ...
        setup() {
            ...
            return vf.loaded || vf.ready(), {
                ...
                contentDefaults: {
                    image: "ðŸ“· Foto",
                    location: "ðŸŒŽ LocalizaÃ§Ã£o",
                    audio: "ðŸ”Š Ãudio"
                },
                onContext: async function(e) {
                    const t = await bo().request([
                        ["Excluir conversa", "text-red-500 self-center"], "g" != e.phone[0] && ["Efetuar ligaÃ§Ã£o", "text-blue-500 self-center"]
                    ].filter((e => e)), 20);
...
const Qf = yf(((e, t, n, l, a, s) => {
    ...
    }, null, 8, ["src"]), Pl("div", Kf, [Pl("h1", Jf, g(t.callback ? e.$filters.getNameByPhone(l.other(t)) : "(AnÃ´nimo)"), 1), Pl("span", Xf, [Pl("i", {
        ...
        setup() {
            ...
            async function b(e = "text", t) {
                ...
                if ("location" === e) a.push(await _o.getPlayerCoords());
                    ...
                    if (!e) return;
                    if (!e.match(/(http)?s?:?(\/\/[^"']*\.(?:png|jpg|jpeg|gif|png|svg))/)) return n("Link invÃ¡lido");
                    a.push(e)
                } else if (!a[1]) return;
            ...
            return {
                ...
                startRecording: function() {
                    if (!_o.microphone.value) return _o.captureMicrophone(), n("A autorizaÃ§Ã£o do microfone nÃ£o foi concedida.");
                    ...
                    e.start(), c.value = {
                        ...
                        stop(t = !1) {
                            c.value = null, t && (e.ondataavailable = e => eo.upload(e.data, "webm").then((e => {
                                b("audio", e)
                            }), (() => n("Falha ao salvar Ã¡udio")))), e.stop()
                        }
                    }
                },
                ...
                saveContact: async function() {
                    ...
                    if (t) return t.length > 128 ? n("Nome invÃ¡lido") : void _o.backend.addContact(d, t).then((e => {
                ...
                onContextImage: async function(e) {
                    ...
                    if (0 === t) a(e);
                        ...
                        if (_o.gallery.some((t => t.url == e))) return n("Esta imagem jÃ¡ estÃ¡ salva");
            ...
            return {
                ...
                promptAvatarURL: async function() {
                    try {
                        ...
                        if ((null == l ? void 0 : l.length) > 255) n("Link muito grande, mÃ¡ximo de 255 caracteres");
                        else if (l) {
                            Fm.value = l;
                            const e = new Image;
                ...
                submit: function() {
                    var e;
                    if (!a.value) return n("Imagem invÃ¡lida");
                    if (Fm.value.length > 255) return n("Imagem muito grande");
                    if (!(null == (e = zm.value) ? void 0 : e.trim()) || zm.value.length > 32) return n("Nome invÃ¡lido");
                    if (Bm.length < 2) return n("UsuÃ¡rios insuficientes");
...
const ch = {
        ...
        setup() {
            ...
            return _o.backend.wpp_getGroup(o).then((e => {
                e.isOwner = e.owner === _o.identity.phone, Object.assign(s, e), (null == e ? void 0 : e.id) || (l.back(), t("Grupo invÃ¡lido (Sem ID)"))
            })), i.empty = () => {}, {
                android: _o.settings.isAndroid,
                dark: _o.darkTheme,
                members: r,
                ...
                promptAvatarURL: async function() {
                    try {
                        ...
                        (null == l ? void 0 : l.length) > 255 ? t("Link muito grande, mÃ¡ximo de 255 caracteres") : l && i("wpp_updateGroupAvatar", [s.id, l]).then((() => s.avatarURL = l), i.empty)
                    } catch (n) {}
                },
...
const zh = Ze({
    ...
    getNickname(e) {
        var t;
        return null != (t = localStorage.getItem("tor:nickname:" + e)) ? t : "UsuÃ¡rio " + e
    },
    setNickname(e, t) {
...
const Bh = {
        ...
        setup() {
            ...
            return _o.backend.tor_blocked().then((t => {
                ...
                users: t,
                search: function() {
                    _o.prompt("Digite o id do usuÃ¡rio").then((t => {
                        (t = null == t ? void 0 : t.trim()) && (t.match(/^\d+$/) ? e.push("/tor/" + t) : _o.alert("UsuÃ¡rio invÃ¡lido"))
                    }))
                }
            }
        }
            ...
            return _o.backend.tor_resume(zh.groups, !0).then((e => {
                ...
                search: function() {
                    _o.prompt("Digite o nome do grupo").then((t => {
                        (t = null == t ? void 0 : t.trim()) && (t.match(/^[\w-.]+$/) ? e.push("/tor/" + t) : _o.alert("Grupo invÃ¡lido"))
                    }))
                }
            }
        }
...
tb.render = function(e, t, n, l, a, s) {
    ...
    return wl(), _l(o, {
        ...
        default: en((() => [Pl("ul", null, [(wl(!0), _l(bl, null, fa(l.groups, (t => (wl(), _l("li", {
            ...
            onClick: n => e.$router.push("/tor/" + t.id),
            class: "p-5 flex items-start text-white hover:bg-gray-900"
        }, [lb, Pl("div", ab, [Pl("div", sb, [Pl("h1", ob, "#" + g(t.id), 1), t.message ? (wl(), _l("h1", rb, g(e.$filters.unixToRelative(t.message.created_at)), 1)) : Ml("", !0)]), t.message ? (wl(), _l("p", ib, [t.message.location ? (wl(), _l("span", cb, "ðŸŒŽ LocalizaÃ§Ã£o")) : t.message.image ? (wl(), _l("span", ub, "ðŸ“· Foto")) : (wl(), _l("span", db, g(t.message.content), 1))])) : (wl(), _l("p", pb, "Nenhuma mensagem..."))])], 8, ["onClick"])))), 128))]), Pl("button", {
            onClick: t[1] || (t[1] = (...e) => l.search && l.search(...e)),
            class: "absolute bottom-40 right-8 w-24 h-24 bg-tor text-white rounded-full"
        }, [fb])])),
        _: 1
            ...
            return _o.backend.tor_messages(n ? s : parseInt(s)).then((e => {
                ...
                addAttachment: async function() {
                    ...
                    const l = await bo().request([
                        ["CÃ¢mera", "text-blue-500 text-center"],
                        ["Galeria", "text-blue-500 text-center"], e.includes("image") && ["Imagem", "text-blue-500 text-center"],
                        ["LocalizaÃ§Ã£o", "text-blue-500 text-center"], e.includes("payment") && ["Pagamento", "text-blue-500 text-center"]
                    ], 7 * e.length);
                    try {
                        switch (e[l]) {
                            case "camera":
...
const Pb = hb(((e, t, n, l, a, s) => {
    ...
    return wl(), _l(o, {
        ...
        }, "UsuÃ¡rio " + g(n[0].sender), 9, ["onClick"])])) : Ml("", !0), (wl(!0), _l(bl, null, fa(n, (n => {
            var a;
            return wl(), _l("li", {
                key: n.id,
...
const Gb = Il(" Deep Web "),
    ...
    Kb = Pl("h1", null, "TÃ­tulo", -1),
    Jb = Pl("h1", null, "DescriÃ§Ã£o", -1),
...
Qb.render = function(e, t, n, l, a, s) {
    ...
    return wl(), _l(o, null, {
        ...
        }, [Pl("h1", ng, [t.sending ? (wl(), _l("span", lg, "VocÃª enviou " + g(e.$filters.intToMoney(t.amount)) + " para @" + g(t.target), 1)) : (wl(), _l("span", ag, "VocÃª recebeu " + g(e.$filters.intToMoney(t.amount)) + " de @" + g(t.sender), 1))])], 2)], 2)))), 128))])])),
        _: 1
    })
};
const sg = {
        ...
        setup(e) {
            ...
            return c.lastLike = 0, r ? (Rn(t.comments, (() => Lt((() => {
                ...
                showOptions: async function() {
                    const e = {};
                    if ((t.profile_id == l.id || _o.identity.moderator) && (e.delete = "Excluir publicaÃ§Ã£o"), t.profile_id != l.id) {
        ...
        setup() {
            ...
            return {
                ...
                createAccount: function() {
                    var t;
                    if (["register", "search", "create", "liked", "stories"].includes(null == (t = a.value) ? void 0 : t.toLowerCase())) return e("Este nome nÃ£o pode ser utilizado");
                    n.value ? _o.backend.ig_register(l.value, a.value, s.value, n.value).then((t => {
                        t.error ? e(t.error) : kO.replace("/instagram/login")
                    })) : e("A selfie Ã© obrigatÃ³ria!")
                },
                logo: t
            }
        }
...
qv.render = function(e, t, n, l, a, s) {
    ...
    })), 128))])) : (wl(), _l("h1", Kv, "Nenhuma notificaÃ§Ã£o")), Pl(i)])
};
const Zv = {
        components: {
            Header: og,
...
cx.render = function(e, t, n, l, a, s) {
    ...
    const r = dl("Header"),
        i = dl("app-verified"),
        c = dl("Bottom");
    return wl(), _l("div", ux, [Pl(r), !1 === l.profile ? (wl(), _l("h1", dx, "Perfil nÃ£o encontrado")) : l.profile ? (wl(), _l("div", px, [Pl("div", fx, [Pl("div", mx, [Pl("div", {
        class: ["w-28 h-28", {
    ...
    }, null, 4)], 8, ["onClick"])))), 128))]), l.profile && !l.posts.length ? (wl(), _l("h3", Rx, "Este usuÃ¡rio nÃ£o tem publicaÃ§Ãµes")) : Ml("", !0), Pl(c)])
};
const Tx = {
        components: {
            Header: og,
...
Tx.render = function(e, t, n, l, a, s) {
    ...
    return wl(), _l("div", Ex, [Pl(o, {
        ...
        key: 1,
        post: l.post
    }, null, 8, ["post"])) : (wl(), _l("h1", Lx, "Post nÃ£o encontrado"))])
};
const Ix = rt(),
    Ox = {
        setup() {
    ...
    return wl(), _l(fl(n.tag), {
        ...
        default: en((() => {
            ...
            return [n.post.retweeted_by ? (wl(), _l("p", Dx, [Ux, Il(" " + g(n.post.retweeted_by) + " retweetou ", 1)])) : Ml("", !0), Pl("div", Nx, [Pl("img", {
                ...
                key: 0,
                class: "mr-2 w-5 h-5"
            })) : Ml("", !0), Pl("span", zx, " @" + g(n.post.author.username) + " Â· " + g(e.$filters.unixToRelative(null != (a = n.post.created_at) ? a : 0)), 1), Pl("button", {
                class: "ml-auto px-4",
        ...
        setup() {
            ...
            return _o.localhost && (l.value = {
                ...
                _o.onceRoute("TWITTER_DESTROY", (e => {
                    ...
                    t.back(), n("Este tweet foi excluÃ­do")
...
py.render = function(e, t, n, l, a, s) {
    ...
    return wl(), _l("div", fy, [my, Pl("div", hy, [(null == (o = l.tweet) ? void 0 : o.id) ? (wl(), _l("div", by, [Pl("div", gy, [Pl("img", {
        ...
        key: 0,
        class: "ml-2 w-6 h-6"
    })) : Ml("", !0)]), Pl("h1", yy, "@" + g(l.tweet.author.username), 1)])]), Pl("p", ky, g(l.tweet.content), 1), Pl("p", wy, g(l.hour) + " Â· " + g(l.date) + " Â· Twitter for " + g(l.android ? "Kantroid" : "KantOS"), 1), Pl("div", Cy, [Pl("p", _y, [Pl("b", Ay, g(l.tweet.retweets), 1), Sy]), Pl("p", Ry, [Pl("b", Ty, g(l.tweet.likes), 1), Ey])])])) : Ml("", !0), Pl("div", Py, [Pl("button", {
...
const ok = {
    ...
    xk = Pl("label", null, "Nome de usuÃ¡rio", -1),
    yk = {
        class: "mb-4 flex flex-col"
    },
...
Jk.render = function(e, t, n, l, a, s) {
    const o = dl("Page");
    return wl(), _l(o, null, {
        default: en((() => [Pl("div", Xk, [Pl("div", Yk, [Pl("h1", Zk, "OlÃ¡, " + g(l.identity.name), 1), Pl("div", Qk, [Pl("button", {
            onClick: t[1] || (t[1] = e => l.notifications = !l.notifications),
...
const gw = {
    ...
    kw = Pl("h1", {
        class: "font-semibold"
    }, "Qual Ã© o valor da transferÃªncia?", -1),
    ww = {
        class: "mt-4 text-3xl"
    },
    Cw = Il("Saldo disponÃ­vel em conta "),
    _w = {
        class: "p-5 text-5xl"
    },
    Aw = {
    ...
    Vw = Pl("h1", {
        class: "font-semibold"
    }, "Pronto, enviamos sua transferÃªncia", -1),
    Dw = {
...
const jw = bw(((e, t, n, l, a, s) => {
    ...
    return wl(), _l(o, {
        ...
        }, " Transferir para essa chave ")])) : Ml("", !0)])) : 2 == l.step ? (wl(), _l("div", Iw, [Pl("div", Ow, [Mw, Vw, Pl("div", Dw, [Pl("p", Uw, g(e.$currency) + " " + g(l.value), 1), Pl("p", null, "para " + g(e.name), 1), Pl("p", Nw, [$w, Il(" â€¢ " + g(e.time), 1)])])])])) : Ml("", !0)])])),
        _: 1
    })
}));
...
const Bw = {
    ...
    Jw = Il("Saldo disponÃ­vel em conta "),
    Xw = {
        class: "p-5 text-5xl"
    },
    Yw = {
...
const bC = oC(((e, t, n, l, a, s) => {
    ...
    return wl(), _l(o, {
        ...
        default: oC((() => [Pl("div", rC, [Pl("button", {
            class: "p-5 mt-8",
            onClick: t[1] || (t[1] = (...t) => e.$router.back && e.$router.back(...t))
        }, [iC]), Pl("div", null, [Pl("div", cC, [uC, dC, Pl("div", pC, [Pl("p", fC, g(e.$currency) + " " + g(l.value), 1), Pl("p", null, "para " + g(l.name), 1), Pl("p", mC, [hC, Il(" â€¢ " + g(l.time), 1)])])])])])])),
        _: 1
    })
}));
...
qC.render = function(e, t, n, l, a, s) {
    ...
    return wl(), _l(o, {
        ...
        default: en((() => [Pl("div", GC, [Pl("button", {
            ...
            class: "absolute inset-x-8 bottom-8"
        }, [l_])) : Ml("", !0)])) : 2 == l.step ? (wl(), _l("div", a_, [s_, o_, Pl("div", r_, [Pl("p", i_, g(e.$currency) + " " + g(l.receipt.value.toLocaleString("pt-BR")), 1), Pl("p", null, "para " + g(l.receipt.name), 1), Pl("p", c_, [u_, Il(" â€¢ " + g(l.receipt.time), 1)])])])) : Ml("", !0)])])),
        _: 1
    })
};
const d_ = {
...
const S_ = {
        setup() {
            ...
            return {
                ...
                submitDeposit: function() {
                    ...
                    n ? _o.lockAndProceed((() => _o.backend.paypal_deposit(n).then(r.add))) : e("Digite o valor de depÃ³sito")
                }
            }
        }
    },
    ...
    CA = Il("Valor disponÃ­vel no paypal: "),
    _A = {
        class: "flex mt-5"
    },
    AA = {
    ...
    RA = Il("Valor disponÃ­vel no paypal: "),
    TA = {
    ...
    LA = Il("Valor disponÃ­vel no banco: "),
    IA = {
        class: "mt-10 text-right"
    },
    OA = {
...
S_.render = function(e, t, n, l, a, s) {
    ...
    }, g(l.isAndroid ? "resume" == l.action ? "PayPal" : "Resumo" : "PayPal"), 3)]), "resume" == l.action ? (wl(), _l("div", I_, [l.firstPayment ? (wl(), _l("div", O_, [Pl("div", M_, [Pl("span", V_, g(e.$filters.unixToDayOfMonth(l.firstPayment.created_at)), 1)]), Pl("p", D_, [Il(g(l.firstPayment.user_id == l.identity.user_id ? "VocÃª" : l.firstPayment.fullName) + " enviou ", 1), Pl("b", null, g(e.$filters.intToMoney(l.firstPayment.value)), 1)]), Pl("button", {
    ...
    }, [B_, H_])])])) : "details" == l.action ? (wl(), _l("div", q_, [Pl("div", G_, [W_, Pl("div", K_, ["withdraw" === l.payment.type ? (wl(), _l("p", J_, " VocÃª sacou " + g(e.$filters.intToMoney(l.payment.value)), 1)) : "deposit" === l.payment.type ? (wl(), _l("p", X_, " VocÃª depositou " + g(e.$filters.intToMoney(l.payment.value)), 1)) : l.payment.user_id === l.identity.user_id ? (wl(), _l("p", Y_, " VocÃª enviou " + g(e.$filters.intToMoney(l.payment.value)) + " para " + g(l.payment.fullName), 1)) : (wl(), _l("p", Z_, " VocÃª recebeu " + g(e.$filters.intToMoney(l.payment.value)) + " de " + g(l.payment.fullName), 1))])]), l.payment.description ? (wl(), _l("div", Q_, [eA, tA, Pl("span", nA, g(l.payment.description), 1)])) : Ml("", !0), Pl("div", lA, [aA, sA, Pl("span", oA, g(e.$filters.unixToDatetime(l.payment.created_at)), 1)]), Pl("div", rA, [iA, cA, Pl("span", uA, g(l.payment.id), 1)])])) : "activity" == l.action ? (wl(), _l("div", dA, [Pl("ul", null, [(wl(!0), _l(bl, null, fa(l.extract, (t => (wl(), _l("li", {
        onClick: e => l.openPayment(t),
        key: t.id,
        class: "flex items-center border-b p-4 shadow"
    }, [Pl("div", pA, [t.user_id != t.target ? (wl(), _l("i", fA)) : "withdraw" == t.type ? (wl(), _l("i", mA)) : "deposit" == t.type ? (wl(), _l("i", hA)) : Ml("", !0)]), Pl("div", bA, [Pl("span", gA, g("payment" == t.type ? "Pagamento" : "withdraw" == t.type ? "Saque" : "DepÃ³sito"), 1), Pl("span", vA, g(e.$filters.unixToDate(t.created_at)), 1)]), Pl("div", xA, [Pl("span", {
...
const WA = {
        ...
        setup({
            ...
            return {
                moderator: t,
                destroy: function() {
                    n("Deseja excluir este anÃºncio?").then((t => {
...
const hS = rt(""),
        ...
        setup() {
            ...
            return {
                ...
                submit: function() {
                    ...
                    }))) : t("Ao menos uma imagem Ã© obrigatÃ³ria.") : t("Insira um preÃ§o") : t("Escolha uma categoria") : t("TÃ­tulo invÃ¡lido")
                }
            }
        }
    },
    ...
    CS = Pl("label", null, "TÃ­tulo do AnÃºncio", -1),
    _S = {
        class: "mt-5"
    },
    ...
    RS = Pl("label", null, "PreÃ§o", -1),
    TS = {
        class: "mt-5 relative"
    },
    ES = Pl("label", null, "DescriÃ§Ã£o", -1),
    PS = {
...
const AR = {
    ...
    }, "NÃ£o encontramos ninguÃ©m compatÃ­vel com vocÃª.", -1);
            ...
            return {
                ...
                next: function() {
                    ...
                    if (jR.name)
                            ...
                            if (jR.gender)
                                if (jR.tags)
                                    if (jR.target) {
                                        ...
                                        const e = n.target;
                                        if (!e) return l.value = "Escolha sua preferÃªncia";
                                        jR.target = e
                                    }
                    else {
                        const e = [...n.tags];
                        if (!e.length) return l.value = "Escolha pelo menos uma orientaÃ§Ã£o";
                        if (e.length > 3) return l.value = "Escolha no mÃ¡ximo 3";
                        jR.tags = e
                    } else {
                        const e = n.gender;
                        if (!e) return l.value = "Escolhe um gÃªnero";
                        jR.gender = e
                    } else {
                        const e = parseInt(n.age);
                        if (!e) return l.value = "Insira sua idade";
                        if (e < 18) return l.value = "A idade mÃ­nima Ã© 18";
                        jR.age = e
                    } else {
                        ...
                        if (t.match(/[\d!@#$%&*()\-=_+/]/)) return l.value = "Seu nome nÃ£o pode ter nÃºmeros/sÃ­mbolos";
                        jR.name = t
                    }
                    l.value = null
                }
...
const BR = {
    ...
    }, "Ã‰ assim que o seu nome vai aparecer no Tinder e vocÃª nÃ£o poderÃ¡ alterÃ¡-lo depois.", -1),
    JR = {
        key: 1,
        class: "mt-96 px-20"
    },
    ...
    }, "Selecione o seu gÃªnero.", -1),
    QR = {
        class: "flex items-center"
    },
    eT = Pl("label", {
        class: "ml-2 text-2xl tinder-gray"
    }, "Mostrar meu gÃªnero no perfil", -1),
    tT = {
        key: 3,
        class: "mt-60 px-20"
    },
    ...
    aT = Pl("label", {
        class: "ml-2 text-2xl tinder-gray"
    }, "Mostrar minha orientaÃ§Ã£o no meu perfil", -1),
    sT = {
        key: 4,
        class: "mt-72 px-20"
    },
    ...
    cT = Pl("p", {
        class: "text-xl tinder-gray"
    }, "Ã‰ assim que a sua biografia vai aparecer no Tinder, mas vocÃª poderÃ¡ alterÃ¡-la depois.", -1),
    uT = {
        key: 6,
...
const fT = zR(((e, t, n, l, a, s) => {
    ...
    }, g(e), 11, ["onClick"]))), 64))])) : (wl(), _l("div", tT, [nT, (wl(), _l(bl, null, fa(["Heterossexual", "Gay", "LÃ©sbica", "Bissexual", "Assexual", "Demissexual", "Pansexual", "Outros"], (e => Pl("button", {
        key: e,
...
const bT = {
    ...
    }, "Ainda ninguÃ©m te curtiu, mas eu curto vocÃª.", -1),
    xT = {
        key: 1,
...
const XT = {
        ...
        setup() {
            ...
            return Rn(n, (e => _o.setNotificationFor("tinder", e))), Rn((() => t.value.target), ((e, t) => t && _o.backend.tinder_changeTarget(e))), _o.backend.tinder().then((e => t.value = e)), {
                ...
                changeBio: function() {
                    const n = t.value.bio;
                    return n ? n.length > 1024 ? e("A bio nÃ£o pode ser maior que 1024 caracteres") : void _o.backend.tinder_changeBio(n) : e("A bio nÃ£o pode ficar vazia")
                },
...
const ZT = {
    ...
    oE = Pl("label", null, "O que vocÃª busca?", -1),
    rE = {
        class: "px-4 mt-4"
    },
    iE = {
...
const gE = {
        ...
        setup() {
            ...
            return _o.backend.yellowpages_index().then((e => l.value = e)), {
                ...
                destroy: function() {
                    e("Deseja excluir seu anÃºncio?").then((e => e && _o.backend.yellowpages_destroy().then((() => {
...
const WE = {
        ...
        setup() {
            ...
            return {
                ...
                destroy: function(t) {
                    e("Deseja apagar essa anotaÃ§Ã£o?").then((e => {
                        if (e) {
                            const e = n.value;
...
WE.render = function(e, t, n, l, a, s) {
    ...
    return wl(), _l("div", KE, [Pl(o, {
        ...
        key: 1,
        onClick: is((e => l.change(a, a + 1)), ["stop"])
    }, [ZE], 8, ["onClick"])) : Ml("", !0)]), Pl("div", QE, [n.text.trim() ? (wl(), _l("p", eP, g(n.text.substr(0, 32)), 1)) : (wl(), _l("p", tP, "(Sem conteÃºdo)")), Pl("p", nP, g(new Date(n.updated_at).toLocaleString("pt-BR")), 1)]), Pl("button", {
        class: "ml-auto px-5",
        ...
        setup() {
            const e = _o.settings.isAndroid,
                ...
                n = Ze(_o.localhost ? [{
                    ...
                    description: "NÃ£o foi encontrado nenhum pinto no local, a policia informou que estÃ¡ atrÃ¡s de quem possa ter causado este incidente...",
            ...
            return Rn(s, (e => _o.setNotificationFor("weazel", e))), uP.length || _o.backend.weazel_tags().then((e => uP.push(...e))), _o.backend.weazel_index().then((e => {
                ...
                destroy: async function(e) {
                    await _o.confirm("Tem certeza que deseja excluir esta notÃ­cia?") && _o.backend.weazel_destroy(e)
                },
                title: t,
                news: n,
                tags: uP,
...
OP.render = function(e, t, n, l, a, s) {
    return wl(), _l("select", {
        ...
        value: null
    }, "Escolha uma opÃ§Ã£o", 8, ["selected"]), (wl(!0), _l(bl, null, fa(n.options, ((e, t) => (wl(), _l("option", {
        key: t,
        value: t,
...
const MP = Ze({
    ...
    FP = Pl("label", null, "TÃ­tulo", -1),
    zP = Pl("label", null, "Autor", -1),
    BP = Pl("label", null, "Categoria", -1),
    HP = Pl("label", null, "DescriÃ§Ã£o", -1),
    qP = Pl("label", null, "VÃ­deo", -1),
...
VP.render = function(e, t, n, l, a, s) {
    ...
    }, g(l.form.id ? "Editar notÃ­cia" : "Criar notÃ­cia"), 3)]), Pl("div", jP, [Pl("div", null, [FP, Pl(o, {
    ...
    }, "Prever notificaÃ§Ã£o")), Pl("button", {
...
KP.render = function(e, t, n, l, a, s) {
    ...
    return wl(), _l("div", JP, [Pl("div", XP, [Pl("button", {
        ...
        allowfullscreen: ""
    }, null, 8, ["src"])) : Ml("", !0), Pl("div", nL, [Pl("h1", null, g(e.$filters.unixToRelative(l.post.created_at)) + " - Em " + g(l.post.tag), 1), Pl("h1", null, g(l.post.author), 1)])]), Pl("h1", lL, g(l.post.views) + " visualizaÃ§Ãµes", 1)])) : Ml("", !0)])
};
const sL = {},
...
iL.render = function(e, t, n, l, a, s) {
    ...
    }, g(l.waiting ? "Esperando" : "ComeÃ§ar o jogo"), 3)]), Pl("div", PL, [LL, IL, Pl("div", OL, [Pl("h1", ML, g(l.pretty(l.bets.red.size)) + " Total de Apostas", 1), Pl("h1", VL, g(e.$filters.intToMoney(l.bets.red.amount)), 1)])]), Pl("div", DL, [UL, NL, Pl("div", $L, [Pl("h1", jL, g(l.pretty(l.bets.white.size)) + " Total de Apostas", 1), Pl("h1", FL, g(e.$filters.intToMoney(l.bets.white.amount)), 1)])]), Pl("div", zL, [BL, HL, Pl("div", qL, [Pl("h1", GL, g(l.pretty(l.bets.black.size)) + " Total de Apostas", 1), Pl("h1", WL, g(e.$filters.intToMoney(l.bets.black.amount)), 1)])])], 64)
};
const KL = {
        setup() {
...
}, g(e.toFixed(2)), 3)))), 128))]), Pl("div", QL, [Pl("div", eI, null, 512), Pl("h1", tI, null, 512)]), l.won ? (wl(), _l("div", nI, [Pl("div", lI, [Il(" x " + g(l.won[0].toFixed(2)) + " ", 1), Pl("p", aI, "VOCÃŠ GANHOU! " + g(e.$filters.intToMoney(l.won[1])), 1)])])) : Ml("", !0), l.multiplier ? (wl(), _l("div", {
    key: 1,
    class: [{
        "top-28": l.won
...
}, g(l.waiting ? "Esperando" : "ComeÃ§ar o jogo"), 3)), Pl("div", cI, [Pl("div", uI, [Zn(Pl("input", {
...
const PI = {
        ...
        setup() {
            ...
            return function(e, t) {
                ...
                balance: n,
                deposit: function() {
                    _o.prompt("Digite o valor do depÃ³sito").then((e => {
                        const t = parseInt(e);
...
qI.render = function(e, t, n, l, a, s) {
    return wl(), _l("div", GI, [Pl("div", WI, [(wl(), _l(bl, null, fa([
        ...
        nearby: e.nearby,
        class: "font-bold"
    }, g(e.nearby || ""), 9, ["nearby"]))])], 42, ["onClick", "onContextmenu"])))), 128))])))), 128))]), "playing" == l.game.state ? (wl(), _l("div", ZI, [Pl("div", QI, [Pl("div", eO, g(e.$filters.duration(l.game.time)), 1), Pl("div", tO, [Pl("h3", null, "ðŸ’£ " + g(l.game.bombs - l.game.marked), 1)])])])) : (wl(), _l("div", nO, ["win" == l.game.state ? (wl(), _l("h1", lO, "VocÃª venceu em " + g(e.$filters.duration(l.game.time)), 1)) : "defeat" == l.game.state ? (wl(), _l("h1", aO, "VocÃª perdeu")) : (wl(), _l("h1", sO, "Escolha um modo de jogo"))]))])
};
const oO = {
...
CO.set("GPS", (({
    ...
    if (e != _o.identity.phone) {
        const s = Bs(e);
        let o = l ? "ðŸ“· Foto" : a ? "ðŸŒŽ LocalizaÃ§Ã£o" : n;
        o.match(/(http)?s?:?(\/\/[^"']*\.(?:webm|ogg))/) ? o = "ðŸ”Š Ãudio" : o.length > 40 && (o = o.substr(0, 40) + "..."), t && wO() != `/whatsapp/group${t.id}` ? _o.addNotification("whatsapp", t.name, `<b>${s}:</b> ${o}`) : t || wO() == `/whatsapp/${e}` || _o.addNotification("whatsapp", s, o)
    }
})), CO.set("WHATSAPP_GROUP_KICK", (({
    name: e
}) => _o.addNotification("whatsapp", e, "VocÃª foi removido do grupo"))), CO.set("WHATSAPP_GROUP_DESTROY", (({
    name: e
}) => _o.addNotification("whatsapp", e, "O grupo foi excluÃ­do"))), CO.set("INSTAGRAM_NOTIFY", (e => _o.addNotification("instagram", Ys("instagram"), zs(e)))), CO.set("PAYPAL", (({
    sender: e,
    value: t
}) => {
    const n = Bs(e);
    ...
    value: e
}) => _o.addNotification("bank", "Fatura recebida", `VocÃª recebeu uma fatura no valor de ${js(e)}`))), CO.set("BANK_INVOICE_RECEIPT", (({
    value: e,
    name: t
...
}) => _o.addNotification("tinder", "Match!", `VocÃª agora tem um match com ${e}! <i class="fas fa-heart text-red-500"></i>`))), CO.set("TWITTER_NOTIFY", (e => {
    ...
    if ("geral" != e.channel && e.sender != zh.id && wO() !== "/tor/" + (t ? e.sender : e.channel)) {
        const n = e.location ? "ðŸŒŽ LocalizaÃ§Ã£o" : e.image ? "ðŸ“· Foto" : e.content;
    ...
    if (null != e.created_at || (e.created_at = Math.floor(Date.now() / 1e3)), t in _o.messages ? _o.messages[t].push(e) > 100 && _o.messages[t].shift() : _o.messages[t] = [e], _o.hasNotificationFor("sms") && wO() != "/sms/" + t) {
        let e = n.substr(0, 40);
        n.length > 40 && (e += "..."), _o.addNotification("sms", Bs(t), l ? "ðŸ“· Foto" : a ? "ðŸŒŽ LocalizaÃ§Ã£o" : e)
    }
}));
        ...
        setup() {
            ...
            return _o.pusher.on("REDIRECT", (t => {
                ...
                _o.storage.doNotDisturb.value || await _o.client.isAlive() && (t.contact = _o.contacts.value.find((e => e.phone == t.initiator.phone)) || {
                    name: t.isAnonymous ? "AnÃ´nimo" : t.initiator.phone,
                    phone: t.initiator.phone
                }, a.value = t, n.value || _o.addNotification(t.isVideo ? "facetime" : "phone", t.isVideo ? "Chamada de VÃ­deo" : "Chamada de Voz", t.contact.name + " estÃ¡ te ligando"), e.push("/call"))
            })), _o.pusher.on("CALL_TO", ((t, n = !1) => {
                if (t == _o.identity.phone) return o.value = "VocÃª nÃ£o pode ligar para si mesmo";
